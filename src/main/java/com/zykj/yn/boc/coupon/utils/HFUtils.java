...
public class HFUtils {
     ...
     * 用户ID
     */
    public static String szAgentId = "100074";
    /**
     * 用户KEY
     */
    public static String key = "cd4ed0a980db4d8e9b3267e580c7aa29";
...
//	public static String phoneNum = "13522378739";//手机号
     ...
     * 话费测试提交地址
     */
    public static String hf_submit_url = "http://fx.flyingenjoy.com:10061/plat/api/old/submitorder";
    /**
     * 流量提交订单地址
     */
     ...
     * 话费查询订单地址
     */
    public static String hf_query_url = "http://fx.flyingenjoy.com:10061/plat/api/old/queryorder";
    /**
     * 流量查询订单地址
     */
     ...
     * 查询余额
     */
    public static String banlance_url = "http://fx.flyingenjoy.com:10061/plat/api/old/queryBalance";
...
//
// 归属地查询
    public static String dq_phone_url = "http://47.105.117.127:10081/phone/api/phonedetail";
    ...
    public static String phoneDq(String phoneNum, String mchid, String keyZ) {
        String nRtn = "";
        try {
            // MD5签名串
            String szTimeStamp = DateUtil.getFormat(new Date(), "yyyy-MM-dd HH:mm:ss");
            String nSortType = telcom(phoneNum);

            String info = "apicode=" + "general"// 用户ID
                    + "&mchid=" + mchid  //订单号
                    + "&phone=" + phoneNum //手机号
                    + "&timestamp=" + szTimeStamp// 当前时间
                    + "&key=" + keyZ;// 密钥
            // 签名小写
            ...
            params.put("apicode", "general");
            params.put("mchid", mchid);
            params.put("phone", phoneNum);
            params.put("timestamp", szTimeStamp);
            params.put("sign", szVerifyString);


            HttpResponse response = HttpUtils.doPost(dq_phone_url, params);
            ...
            if (status.getStatusCode() == 200) {
                ...
                // 请判断nRtn状态是否提交成功
                nRtn = object.getString("province");
            } else {
                // 请求异常
            }
        } catch (Exception e) {
